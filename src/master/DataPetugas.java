...
//        jComboBox1.removeAllItems();
    ...
    private void aturTable() {
        ...
        try {
            sql = "SELECT * FROM tb_petugas INNER JOIN tb_level ON tb_petugas.id_level = tb_level.id_level WHERE tb_petugas.id_level = 2";
    ...
    private void initComponents() {
        ...
        setTitle("Radja USK | Data Petugas");
        setResizable(false);
        ...
        labelDataPetugas.setText("Data Petugas");
        ...
        idPetugas.setEditable(false);
        idPetugas.setFont(new java.awt.Font("Verdana", 0, 11)); // NOI18N
        ...
        panelAdminLayout.setHorizontalGroup(
            ...
            .addGroup(panelAdminLayout.createSequentialGroup()
                ...
                .addGroup(panelAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(SPTblAdmin, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
                    .addGroup(panelAdminLayout.createSequentialGroup()
                ...
                .addGroup(panelAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnReset, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                    .addComponent(btnKembali, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE)
                    .addComponent(btnLaporan, javax.swing.GroupLayout.DEFAULT_SIZE, 93, Short.MAX_VALUE))
                .addContainerGap())
        );
...
//                   level = jComboBox1.getSelectedIndex() == 1 ? 1 : 2;
                ...
                if (rs.next()) {
                    ...
                    sql = "INSERT INTO tb_petugas VALUES (" + null + ",'" + nama.getText() + "','" + username.getText() + "','" + pass + "', '2')";
                    stat.execute(sql);
...
//                level = jComboBox1.getSelectedIndex() == 1 ? 1 : 2;
                ...
                if (session.getUsername().equals(username.getText())) {
                    if (password.getText().isEmpty()) {
                        sql = "UPDATE tb_petugas SET nama_petugas='" + nama.getText() + "', username='" + username.getText() + "', id_level='2' WHERE id_petugas='" + idPetugas.getText() + "'";
                    } else {
                        if (password.getText().length() < 7) {
                            JOptionPane.showMessageDialog(null, "Password minimal terdiri dari 7 huruf");
                            return;
                        } else {
                            sql = "UPDATE tb_petugas SET nama_petugas='" + nama.getText() + "', username='" + username.getText() + "', password='" + pass + "', id_level='2' WHERE id_petugas='" + idPetugas.getText() + "'";
                        }
                    }
                    ...
                    if (rs.next()) {
                        ...
                        if (password.getText().isEmpty()) {
                            ...
                            if (password.getText().length() < 7) {
                                ...
                                sql = "UPDATE tb_petugas SET nama_petugas='" + nama.getText() + "', username='" + username.getText() + "', password='" + pass + "', id_level='2' username='" + username.getText() + "' WHERE id_petugas='" + idPetugas.getText() + "'";
                            }
                        }
                    }
                } else {
...
//                jLabel7.setVisible(false);
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        try {
            sql = "DELETE FROM tb_petugas WHERE id_petugas='" + idPetugas.getText() + "'";
            stat.execute(sql);
...
//            jLabel7.setVisible(false);
    ...
    private void btnLaporanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLaporanActionPerformed
        try {
            File file = new File("src/laporan/LaporanDataPetugas.jasper");
